/* In this folder we will create our API of 50 questions
each question will have: its topic, answers, correct answer, and question ID.
and we will export 5 random questions */
const qBank = [
  {
    question:
